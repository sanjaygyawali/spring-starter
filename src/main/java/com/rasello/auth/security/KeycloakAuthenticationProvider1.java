...
//@Configuration
public class KeycloakAuthenticationProvider1 extends ContainerBasedAuthenticationProvider {

    private static final Logger LOGGER = LoggerFactory.getLogger(KeycloakAuthenticationProvider1.class);
