...
public class DefaultTableService implements TableService {
    ...
    public DefaultTableService(WebApplicationContext context, ListableBeanFactory beanFactory) {
    ...
    public <E> Specification<E> createSpecification(Class<E> entityClass, TableRequest request) {
        return (root, query, builder) -> {
            ...
            return builder.and(predicates.toArray(new Predicate[]{predicates.get(0)}));
        };
    }
